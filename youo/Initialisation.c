...
/***Lance la musique***/
void lancer_musique(SAMPLE* music){
    music = load_wav("musique.wav");
    play_sample(music, 255, 0, 2000, 0);
     stop_sample ( music );//Condition a rajouter ou je lance par rapport au clique droit ou gauche de la soursi pour lancer ou non la music
    }
