...
void mode_communiste(BITMAP *page, BITMAP *detection, t_bat *batiment, t_joueur *player, BITMAP *map, t_graphe *reseau, t_graphe *g) {
    t_case case_actu;
    t_case **plateau;
    t_bat *centrale;
    t_bat *chateau;
...
int main() {
    ...
    while (!key[KEY_ESC]) {
        ...
        if (modedejeu == 1) {
            ...
            mode_communiste(page, detection, batiment, player, map, reseau, g);
        } else if (modedejeu == 3) {
            // CHARGER UNE PARTIE
